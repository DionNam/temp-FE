              ...
              <div className="bg-[rgba(239,239,239,0.2)] box-border content-stretch flex flex-col gap-6 sm:gap-7 items-center justify-start px-4 sm:px-10 py-6 sm:py-8 relative rounded-[20px] shrink-0 w-full max-w-[540px] border border-[#f2f4f7]">
                <div className="content-stretch flex flex-col gap-4 items-center justify-start relative shrink-0 w-full">
                  <div className="content-stretch flex flex-col gap-7 items-center justify-center relative shrink-0 w-full">
                    <div className="content-stretch flex flex-col gap-4 items-center justify-start relative shrink-0 w-full">
                      {/* Main Title */}
                      <h1 className="font-medium text-[#141c25] text-[22px] sm:text-[28px] text-center tracking-[-0.28px] w-full leading-[28px] sm:leading-[36px]">
                        Thank you for joining our waitlist!
                      </h1>
                      
                      {/* Subtitle */}
                      <p className="font-normal text-[#141c25] text-[16px] sm:text-[18px] text-center w-full leading-[24px] sm:leading-[28px]">
                ...
                {/* Demo Button */}
                <div className="content-stretch flex flex-col gap-6 sm:gap-10 items-center justify-start relative shrink-0 w-full">
                  <div className="content-stretch flex flex-col gap-3 items-center justify-center relative shrink-0 w-full">
                    <button
                      onClick={handleDemoClick}
                      className="bg-[#141c25] box-border content-stretch flex gap-2 items-center justify-center px-4 sm:px-5 py-3 sm:py-2.5 relative rounded-[10px] shadow-[0px_1px_2px_0px_rgba(20,28,37,0.04)] shrink-0 w-full hover:bg-[#0f1419] transition-colors"
                    >
                      <div className="font-medium text-[14px] sm:text-[16px] text-center text-white">
                        Check our Demo App
                      </div>
                    </button>
                  </div>
