...
export default function BlogManagementPage() {
  ...
  return (
    <div className="min-h-screen bg-primary-blue-50">
      ...
      <Link
        href="/blog/create"
        className="md:hidden fixed right-6 top-1/3 transform -translate-y-1/2 z-40 w-14 h-14 bg-primary-blue-600 text-white rounded-full shadow-lg hover:bg-primary-blue-700 transition-all duration-200 flex items-center justify-center hover:scale-110"
