...
interface BlogManagementLayoutProps {
  children: React.ReactNode;
}

export function BlogManagementLayout({ children }: BlogManagementLayoutProps) {
  return (
    <div className="min-h-screen bg-primary-blue-50 relative">
      <div className="sticky bg-transparent top-1/2 right-0 w-full h-full z-10 pr-2">
